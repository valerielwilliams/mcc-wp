...
function html5blank_header_scripts()
{
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
        wp_register_script('ahha-js', get_template_directory_uri() . '/assets/dist/js/app.js', array('jquery'), '1.0.0', true); // Custom scripts
...
// MOVE COMMENT TEXTAREA TO THE BOTTOM OF THE FORM - Thanks Amy and wpbeginner.com
      ...
      <div class="comments__responses__one">
          ...
          <div class="comments__responses__one__original">
              ...
              <div class="comments__responses__content">
                  ...
                  <h3 class="comments__responses__subheading"><?php echo get_comment_author_link(); ?></h3>
                  <?php if ($comment->comment_approved == '0') : ?>
